...
* 👨‍🏫 Dr. rer. nat. Martin Möddel, 🧑‍🏫 [Sarah Reiß, M.Sc.](mailto:sarah.reiss@tuhh.de)

📅 Due date: 21.10.2025, 1 p.m.
"""
...
# ╔═╡ 0f50de55-b6b9-485f-9357-2ba189a4864e
α = 14
...
# ╔═╡ e9606938-c1e8-4b1e-b5fb-83543523ead0
begin
	fig = Figure()
	ax = Axis(fig[1, 1]; xlabel = "x", ylabel = "exp(x)", title = "Exponential Function")
	lines!(ax,x,exp.(x), color = :red)
	fig
end;
...
begin
	figB, axB, spB = series(x,yseries, labels=["ellipse" "line1" "circle" "line2"])
	axislegend(axB)
	figB
end;
...
# ╔═╡ f2a2a3de-f659-4e73-9d5d-2f5788b6c0e4
