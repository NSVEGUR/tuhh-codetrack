...
* 👨‍🏫 Dr. rer. nat. Martin Möddel, 🧑‍🏫 Sarah Reiß, M.Sc.
"""
...
begin
	fig1 = Figure()
	ax1 = Axis(fig1[1, 1], xlabel = "x", ylabel = "y", title = "circle", aspect = 1)
...
md"""
Passing a (`m` × `n`) matrix of values (numbers, etc) to the `series` function will plot `m` series, each with `n` data points. Each row is interpreted as a separate series.
"""
...
# ╔═╡ 42106cd6-e37d-4e27-b113-e7c487886b69
series(x,yseries)

# ╔═╡ 62563bf2-0a2e-4c22-b294-0059cb8f3b76
md"""
...
begin	
		...
		series!(x,yseries, labels = ["ellipse" "line1" "circle" "line2"])
		axislegend()
...
manifest_format = "2.0"
project_hash = "6054e46cbba6d20d1a3d26899a6497fd6be44b2a"
