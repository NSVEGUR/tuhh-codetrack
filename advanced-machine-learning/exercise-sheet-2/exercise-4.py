...
def load_mnist() -> tuple[tuple[ArrayLike, ArrayLike],
...
if __name__ == '__main__':
    ...
    print("W1 shape:", model.weights[0].shape)  # Should be (100, 784)
